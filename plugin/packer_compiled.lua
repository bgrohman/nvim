...
_G.packer_plugins = {
  ["auto-session"] = {
    loaded = true,
    path = "/Users/bryan/.local/share/nvim/site/pack/packer/start/auto-session",
  ...
  catppuccin = {
    loaded = true,
    path = "/Users/bryan/.local/share/nvim/site/pack/packer/start/catppuccin",
  ...
  ["gitsigns.nvim"] = {
    loaded = true,
    path = "/Users/bryan/.local/share/nvim/site/pack/packer/start/gitsigns.nvim",
    url = "https://github.com/lewis6991/gitsigns.nvim"
  },
  gruvbox = {
    loaded = true,
    path = "/Users/bryan/.local/share/nvim/site/pack/packer/start/gruvbox",
  ...
  ["lualine.nvim"] = {
    loaded = true,
    path = "/Users/bryan/.local/share/nvim/site/pack/packer/start/lualine.nvim",
  ...
  ["onedarkpro.nvim"] = {
    loaded = true,
    path = "/Users/bryan/.local/share/nvim/site/pack/packer/start/onedarkpro.nvim",
  ...
  ["symbols-outline.nvim"] = {
    loaded = true,
    path = "/Users/bryan/.local/share/nvim/site/pack/packer/start/symbols-outline.nvim",
